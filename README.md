...
<p align="center">
<img src="https://telegra.ph/file/6abaae73efb27d7127781.jpg" alt="YesithBot-TK" width="900"/>
</p>
...
<p align="center">
<a href="#"><img title="YesithBot-TK" src="https://img.shields.io/badge/COMPATIBLE CON LA VERSIÓN MULTI DISPOSITIVOS DE WHATSAPP-red?colorA=%F77F48FF&colorB=%F77F48FF&style=for-the-badge"></a>
</p>
...
<a href="https://www.tiktok.com/@yesith_tk?_t=8nuJiwgs2S5&_r=1">
...
```
```bash
apt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - https://raw.githubusercontent.com/Yesith312/YesithBot-TK/master/joan.sh | bash
```
```js
...
// REFERENCIA
"wget -O - https://raw.githubusercontent.com/Yesith312/YesithBot-TK/master/joan.sh | bash"
...
//Ejemplo: git clone https://github.com/Yesith312/YesithBot-TK.git

209 --> "cd [repositorio]"
//Ejemplo: cd YesithBot-TK
...
```
```bash
git clone https://github.com/Yesith312/YesithBot-TK.git
```
```bash
cd YesithBot-TK
```
...
apt upgrade
pkg install -y git nodejs ffmpeg imagemagick yarn
cd storage/downloads/JoanBot-TK-master/JoanBot-TK-master 
yarn install
npm install
npm start
```
...
> **Note** Guardar los archivos en la ubicación: storage/downloads/JoanBot-TK-master/JoanBot-TK-master   
----
### 🚀 USAR JoanBot-TK 24/7 EN TERMUX 
> Ejecutar estos comandos dentro de la carpeta JoanBot-TK
```bash
...
```bash
grep -q 'bash\|wget' <(dpkg -l) || apt install -y bash wget && wget -O - https://raw.githubusercontent.com/JJoan02/JoanBot-TK/master/update.sh | bash 
```
...
> Tutorial para activar **JoanBot-TK** en un servidor reconocido y para todos.
